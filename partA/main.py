...
if __name__ == '__main__':
    ...
    parser.add_argument("-a", "--activation", type=str,default='relu', choices=['relu','tanh','mish','silu','selu','gelu'], help="Activation function to be used.")
    ...
    model.train_network(train_data=train_dataset,val_data=val_dataset,test_data=test_dataset,
                        lr=lr,weight_decay=weight_decay,early_stopping_patience=patience_counter,log=False)
